...
// import { withAuthenticator, Authenticator, Button, Text, Flex, Heading, Grid} from "@aws-amplify/ui-react";
...
//           <Heading level={1} color='white' column={1} row={1} paddingLeft="1%">{user.username}</Heading>
